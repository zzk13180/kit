...
export function setScreenPointFlex(
  point: DaBreakpoint,
  context: any,
  elementRef: ElementRef,
  renderer: Renderer2,
...
export function setScreenPointStyle(
  point: DaBreakpoint,
  context: any,
  elementRef: ElementRef,
  renderer: Renderer2,
