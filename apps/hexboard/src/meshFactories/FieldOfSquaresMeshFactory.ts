...
export class FieldOfSquaresMeshFactory {
  ...
  getMesh(item: Item, scene: Scene) {
    ...
    cube1.parent = parentMesh
    cube2.parent = parentMesh
    cube3.parent = parentMesh
    cube4.parent = parentMesh

    return parentMesh
  }

  createSquare(minX: number, maxX: number, minY: number, maxY: number, scene: Scene) {
